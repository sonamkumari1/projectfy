...
function ProjectCard({ data }) {
  ...
  return (
    ...
    <div className="relative w-full max-w-xs bg-black border border-gray-800 rounded-lg shadow-2xl shadow-gray-800 transform hover:scale-105 transition duration-300 ease-in-out">
