  ...
  return (
    <div className="w-full max-w-screen-xl mx-auto mt-5 border border-white/16 rounded-full bg-white/8 backdrop-blur-md px-8 py-1 flex items-center justify-between">
      ...
      <div className="flex items-center justify-center gap-5">
        {user ? (
          <div onClick={()=> setDropdownOpen(!dropdownOpen)} className="text-zinc-100 rounded-full px-5 py-1.5 bg-zinc-900 font-medium text-lg flex items-center transition border border-zinc-700 relative overflow-hidden group uppercase">
            {firstLetter}
